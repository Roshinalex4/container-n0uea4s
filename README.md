...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n0uea4s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n0uea4s.containers.anotherwebservice.com/
...
```
git clone git@github.com:Roshinalex4/container-n0uea4s.git
cd container-n0uea4s
```
...
```
docker attach container-n0uea4s
```
